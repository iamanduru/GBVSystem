...
public class ReportDAO {
    ...
    public boolean insertReport(Report report) {
        ...
        String SQL_INSERT = "INSERT INTO reports (survivor_alias, description, location, date_reported, category_id) VALUES (?, ?, ?, ?, ?)";
    ...
    public List<Report> getAllReports() {
        ...
        final String SQL_SELECT = "SELECT * FROM reports";
    ...
    public boolean updateReport(Report report) {
        final String SQL_UPDATE = "UPDATE reports SET survivor_alias=?, description=?, location=?, date_reported=?, category_id=? WHERE report_id=?";
    ...
    public boolean deleteReport(int reportId) {
        final String SQL_DELETE = "DELETE FROM reports WHERE report_id=?";
